...
class EpuckBasic(DifferentialWheels):
    ...
    def spin_cw(self, speed=1.0, duration=1):
        self.spin(speed=speed, dir='cw', duration=duration)

    def spin_ccw(self, speed=1.0, duration=1):
        self.spin(speed=speed, dir='ccw', duration=duration)
